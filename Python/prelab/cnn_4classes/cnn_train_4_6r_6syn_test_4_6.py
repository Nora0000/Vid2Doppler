...
new_model_path = "../../models/cnn_train_4_6r(1%)_test_4_6/"
...
x4_real = np.load(os.path.join(path4, "X_4.npy"))
y4_real = np.load(os.path.join(path4, "Y_4.npy"))
x4_aug, y4_aug = augment_data(x4_real, y4_real)
...
x6_syn_aug, y6_syn_aug = augment_data(x6_syn, y6_syn)

# sensor 6 real data for test
path6 = "/home/mengjingliu/Vid2Doppler/data/2023_07_19/HAR6"
x6_real = np.load(os.path.join(path6, "X_4.npy"))
y6_real = np.load(os.path.join(path6, "Y_4.npy"))
...
X_train_6_real = np.repeat(X_train_6_real, 100, axis=0)
y_train_6_real = np.repeat(y_train_6_real, 100, axis=0)

X_train = np.vstack((X_train_4, X_train_6_real))
# X_train = np.vstack((X_train, x6_syn_aug))
y_train = np.concatenate((y_train_4, y_train_6_real)) - 1
# y_train = np.concatenate((y_train, y6_syn_aug)) - 1
