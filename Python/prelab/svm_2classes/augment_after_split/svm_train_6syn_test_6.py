...
x6_real_train, x6_real_test, y6_real_train, y6_real_test = train_test_split(x6_real, y6_real, test_size=0.8, random_state=42)
# _, x6_real_train_, _, y6_real_train_ = train_test_split(x6_real_train, y6_real_train, test_size=0.04, random_state=42)
...
X_train = np.vstack((x6_aug_syn, x6_aug_real))
y_train = np.concatenate((y6_aug_syn, y6_aug_real))
# X_train = x6_aug_real
# y_train = y6_aug_real
X_test = x6_real_test
y_test = y6_real_test
