...
new_model_path = "../../../models/svm_train_4_6_test_4_6/"
...
y4 = np.load(os.path.join(path4, "Y_4.npy")) - 1
...
X_train_6, X_test_6, y_train_6, y_test_6 = train_test_split(x6_aug_real, y6_aug_real, test_size=0.2, random_state=42)


X_train = np.vstack((X_train_4, X_train_6))
y_train = np.concatenate((y_train_4, y_train_6))
