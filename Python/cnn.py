...
X = np.vstack((x4_aug, x6_aug))
y = np.concatenate((y4_aug, y6_aug)) - 1

# Normalize the pixel values to range [0, 1]
X_train, X_test, y_train, y_test = train_test_split(x6_aug, y6_aug-1, test_size=0.2, random_state=42)
...
np.save("/home/mengjingliu/Vid2Doppler/data/2023_07_19/X_6_test.npy", X_test)
np.save("/home/mengjingliu/Vid2Doppler/data/2023_07_19/y_6_test.npy", y_test)

# Build the CNN model
model = Sequential()

# Convolutional layers
model.add(Conv2D(16, kernel_size=(3, 3), activation='relu', input_shape=(32, 50, 1)))
...
new_model_path = "../models/cnn_train_6_test_6/"
