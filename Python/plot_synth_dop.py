...
def main(args):
	...
	length = min(len(synth_spec_test), len(dop_spec_test))
...
if __name__ == '__main__':
	...
	parser.add_argument('--input_video', type=str, help='Input video file',
	                    default='../data/2022_11_09/har1/2022_11_09_15_27_39_Allie_walking/video_segments/segment_1th_minute.mp4')

	parser.add_argument('--model_path', type=str, help='Path to DL models', default='../models/')

	parser.add_argument('--doppler_gt', help='Doppler Ground Truth is available for reference', action='store_true', default=True)
