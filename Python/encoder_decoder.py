...
def main(args):
	...
	for i in range(1000):
		...
		history = autoencoder.fit(X_train, y_train, batch_size=batch_size, epochs=20, validation_data=(X_val, y_val), shuffle=True, workers=1)
		if history_all == {}:
