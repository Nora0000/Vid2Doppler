"""
in training phase 1, use 4 activities'  real and synthetic data, one activity with only synthetic data.
"""
import sys
import torch
...
X_train_r1, X_test_r, y_train_r1, y_test_r = train_test_split(X_real, y_real, test_size=0.2, random_state=42)
indices = (y_train_r1 != leave_out)
X_train_r_ = X_train_r1[indices]
y_train_r_ = y_train_r1[indices]
X_train_r, X_val_r, y_train_r, y_val_r = train_test_split(X_train_r_, y_train_r_, test_size=0.1, random_state=42)
...
indices = (y_train_s != leave_out)
X_train_r = X_train_s[indices]
y_train_r = y_train_s[indices]
