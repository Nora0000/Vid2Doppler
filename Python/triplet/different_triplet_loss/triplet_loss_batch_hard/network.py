...
embedding_model = tf.keras.models.Sequential([
	Conv2D(32, (5, 5), padding='same', strides=(2, 2), kernel_initializer=HeNormal(), bias_initializer=HeNormal()),
	LeakyReLU(),
	MaxPooling2D((2, 2), padding='same'),
	Conv2D(64, (5, 5), padding='same', strides=(2, 2), kernel_initializer=HeNormal(), bias_initializer=HeNormal()),
	LeakyReLU(),
	MaxPooling2D((2, 2), padding='same'),
	Flatten(),
	# Dropout(0.2),
	Dense(256, kernel_initializer=HeNormal(), bias_initializer=HeNormal()),
	LeakyReLU(),
	# Dropout(0.2),
	Dense(256, kernel_initializer=HeNormal(), bias_initializer=HeNormal()),
	LeakyReLU(),
...
train_generator = DataGeneratorBH_realAnchor_randomBatch(embed_model, batch_size=batch_size, class_num=class_num, data_real=X_train_r, labels_real=y_train_r, data_syn=X_train_s, labels_syn=y_train_s)
test_generator = DataGeneratorBH_realAnchor_randomBatch(embed_model, batch_size=batch_size, class_num=class_num, data_real=X_test_r, labels_real=y_test_r, data_syn=X_test_s, labels_syn=y_test_s)
val_generator = DataGeneratorBH_realAnchor_randomBatch(embed_model, batch_size=batch_size, class_num=class_num, data_real=X_val_r, labels_real=y_val_r, data_syn=X_val_s, labels_syn=y_val_s)
